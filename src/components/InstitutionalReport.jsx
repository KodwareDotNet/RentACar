...
const InstitutionalReport = ({ reports, summary, startDate, endDate, revenueExpenses }) => (
    <Document>
        ...
        <Page size="A4" style={styles.page}>
            ...
            {/* Booking Table */}
            <Text style={{ fontWeight: "bold", marginBottom: 5 }}>1. Booking Details</Text>

            <View style={{ flexDirection: "column", marginBottom: 10 }}>
                {/* Table Header */}
                <View style={{ flexDirection: "row" }}>
                    <Text style={{ flex: 1, fontSize: 10, fontWeight: "bold", borderWidth: 1, borderColor: "#000", padding: 3 }}>Booking ID</Text>
                    <Text style={{ flex: 1, fontSize: 10, fontWeight: "bold", borderWidth: 1, borderColor: "#000", padding: 3 }}>Car</Text>
                    <Text style={{ flex: 1, fontSize: 10, fontWeight: "bold", borderWidth: 1, borderColor: "#000", padding: 3 }}>Customer</Text>
                ...
                {reports.map((r) => (
                    <View style={{ flexDirection: "row" }} key={r.bookingId}>
                        <Text style={{ flex: 1, fontSize: 10, borderWidth: 1, borderColor: "#000", padding: 3 }}>{r.bookingId}</Text>
                        <Text style={{ flex: 1, fontSize: 10, borderWidth: 1, borderColor: "#000", padding: 3 }}>{r.carName}</Text>
                        <Text style={{ flex: 1, fontSize: 10, borderWidth: 1, borderColor: "#000", padding: 3 }}>{r.customer}</Text>
